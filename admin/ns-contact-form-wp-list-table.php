...
class NS_Contact_Form_Table_List extends WP_List_Table
{
    /**
    ...
    function column_name($item)
    {
        ...
        $actions = array(
            'edit' => sprintf('<a href="?page=ns_simple_contact_form_add&id=%s">%s</a>', $item['id'], __('Edit', 'nuno-sarmento-simple-contact-form')),
            'delete' => sprintf('<a href="?page=%s&action=delete&id=%s">%s</a>', $_REQUEST['page'], $item['id'], __('Delete', 'nuno-sarmento-simple-contact-form')),
            'export'        => '<a href="admin.php?page=ns_simple_contact_form_export">Export Form</a>',
