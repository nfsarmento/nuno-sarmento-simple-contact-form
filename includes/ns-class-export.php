 ...
 * @since 1.2
 */
class NSVisualFormBuilder_Export {
	/**
	 * field_table_name
	 *
	 * @var mixed
	...
	public function display(){
		...
		$where = apply_filters( 'ns_contact_form', '' );
        ...
        <form method="post" id="vfb-export">
        	...
        	<p><label><input type="radio" name="vfb-content" value="forms"/> <?php _e( 'Forms', 'visual-form-builder' ); ?></label></p>
